...
function Marquee() {
  ...
  return (
    <div style={{ borderTop:"1px solid var(--g600)", borderBottom:"1px solid var(--g600)", overflow:"hidden", padding:"12px 0", background:"var(--g900)" }}>
      <div style={{ display:"flex", animation:"marquee 30s linear infinite", whiteSpace:"nowrap" }}>
        {rep.map((t,i) => (
          <span key={i} style={{ fontFamily:"var(--fm)", fontSize:"10px", letterSpacing:"0.22em", textTransform:"uppercase", fontWeight:"500", color:i%2===0?"var(--green)":"var(--g400)", padding:"0 34px" }}>
