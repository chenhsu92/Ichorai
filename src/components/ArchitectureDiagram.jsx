...
const C = {
  ...
  surface:   "#1a1a1a",        // --g800
  border:    "#3a3a3a",        // --g600
  borderDark:"#070707",        // --black
  mint:      "#5aff8f",        // --green
  mintLight: "rgba(90,255,143,0.1)",
  mintDark:  "#5aff8f",
  sage:      "#7ABFA0",        // keep original
  ink:       "#F4F3EF",        // --white
  inkMid:    "#bbb",           // --g200
  inkLight:  "#777",           // --g400
};
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <p style={{ fontSize: 12.75, color: "var(--g400)", letterSpacing: "3px",
      ...
      <svg ref={svgRef} width="100%" viewBox={`0 0 ${W} ${H}`}
        ...
        <defs>
          ...
          <linearGradient id="dmGrad" x1="0" y1="1" x2="0" y2="0">
            <stop offset="0%" stopColor="#ffb84d" stopOpacity="0.05" />
        ...
        <rect x={W - PAD - 82} y={DM_Y + 10} width={70} height={20} rx="10"
          fill="rgba(255,184,77,0.1)" stroke="#ffb84d" strokeWidth="0.7" />
        <text x={W - PAD - 47} y={DM_Y + 20}
          textAnchor="middle" dominantBaseline="middle"
          fill="#ffb84d" fontSize="10.5" fontFamily={MONO} fontWeight="500" letterSpacing="1">
          80% LAYER
        </text>
      ...
      <div style={{
        ...
        {[
          ...
          { color: "#ffb84d", label: "Data Manager — 80% Foundation Layer"  },
